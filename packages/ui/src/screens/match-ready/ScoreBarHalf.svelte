			...
			<div class="flex flex-row z-10 relative" style={`max-width: ${$wingSpring / 2}vw; opacity: ${$opacityTween}`} class:flex-row-reverse={invert}>
				...
				<div class="flex flex-col justify-center h-full">
					<div
						...
						class:collapse={!score.coopertitionMet}
					>
						<img src="/coop.png" alt="coop" class="size-12" />
					</div>
				</div>

				<div class="flex flex-col px-4 text-4xl font-medium tracking-tighter justify-center text-center text-nowrap min-w-56 gap-2 my-2">
					<div class="flex justify-between bg-white text-black rounded-full py-2 px-4 items-center gap-3" class:flex-row-reverse={invert}>
						...
						<img src="/algea.png" alt="algea" class="size-12" />
					</div>
					<div
					...
					>
						...
						<img src="/coral.png" alt="coral" class="size-12" />
					</div>
				</div>
