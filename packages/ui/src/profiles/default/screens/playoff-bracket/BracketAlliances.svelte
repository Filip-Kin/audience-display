...
<div class="flex flex-col justify-center h-full gap-3">
	{#each alliances as alliance, allianceIdx (alliance.allianceNumber)}
		...
		>
			<div class="grid items-stretch h-full grid-cols-[290px_1fr] bg-white text-[oklch(0.14_0_0)]">
				<div class="display flex items-center justify-center gap-3 text-[40px] text-white bg-[oklch(0.32_0.01_250)]">
